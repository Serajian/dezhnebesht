...
۹۵ تست، روی ماژول‌های خالص و روی دادهٔ واقعی روی دیسک. بعد `#/self-test` را باز کن: هر مدخل را در **هر دو زبان** رندر می‌کند و خطاهای رندر، خطاهای اعتبارسنجی و مدخل‌های بدون ترجمهٔ انگلیسی را گزارش می‌دهد.
