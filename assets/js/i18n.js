...
export const STRINGS = {
  fa: {
    ...
    'entry.share': 'هم‌رسانی',
    'entry.shareCopied': 'کپی شد',
    'entry.shareFailed': 'کپی نشد',
    'entry.shareLabel': 'هم‌رسانی این مدخل',
  ...
  en: {
    ...
    'entry.share': 'Share',
    'entry.shareCopied': 'Copied',
    'entry.shareFailed': 'Could not copy',
    'entry.shareLabel': 'Share this entry',
